...
set :application, "rails_intro"
set :repo_url, "git@github.com:Diogo-Ferreira/rails-intro.git"
set :branch, "the-end"
...
set :deploy_to, "home/diogo/www/rails-intro"
...
namespace :deploy do
  after :finished, :restart_puma do
    on roles(:web) do
      execute :sudo, 'service puma-diogo restart'
